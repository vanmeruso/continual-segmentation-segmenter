...
def tensorboard_image(inputs=None, outputs=None, labels=None, bgr=[103.53, 116.28, 123.675], std=[57.375, 57.12, 58.395]):
    ## images
    inputs[:,0,:,:] = std[0] * inputs[:,0,:,:] + bgr[0]
    inputs[:,1,:,:] = std[1] * inputs[:,1,:,:] + bgr[1]
    inputs[:,2,:,:] = std[2] * inputs[:,2,:,:] + bgr[2]
